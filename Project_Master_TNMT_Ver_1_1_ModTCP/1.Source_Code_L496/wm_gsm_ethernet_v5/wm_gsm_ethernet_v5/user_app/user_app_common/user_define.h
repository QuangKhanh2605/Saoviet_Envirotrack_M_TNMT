...
/*     Chu ki wake up
      ...
      - Don vi (s)
*/
#define DEFAULT_FREQ_WAKEUP                             2       // (min)
#define DEFAULT_NUM_TSVH                                1     

#define MAX_NUM_TSVH                                    100     
#define MAX_NUM_DURA                                    60      // (min)

#define DEFAULT_DURA_ALARM                              300     // (s)        
