...
//			id ENUM		    kind process		  str Received
    ...
    {_SET_FTP_SER_MAIN, 	NULL,	        {(uint8_t*)"at+ftpmain=",11}},   //Ex: at+ftpmain=124.158.5.154,21,admin,admin,chien/test_tn  at+chaninfor=6,SV|HOANGNGOC|TANG2|2,0,1
    ...
    {_GET_STATE_CALIB_SS,   NULL,           {(uint8_t*)"at+statecalib?",14}},
    {_SET_STATE_CALIB_SS,   NULL,           {(uint8_t*)"at+statecalib=",14}},
