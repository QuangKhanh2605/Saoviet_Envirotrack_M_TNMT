...
{
    HAL_UART_Transmit(&huart1, pData, Length, 1000);
}
...
int main(void)
{
  ...
  pFunc_UTIL_Debug_Send  = &AppComm_Uart_Debug_Send;
    ...
    UTIL_Printf_Str (DBLEVEL_L, (const char *) &aSaoVietCom);
	...
	NewFirmwareSize = *(__IO uint32_t*)(ADDR_FLAG_HAVE_NEW_FW + FLASH_BYTE_WRTIE);
