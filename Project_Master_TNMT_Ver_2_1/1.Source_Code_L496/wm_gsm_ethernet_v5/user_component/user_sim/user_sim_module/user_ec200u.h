...
typedef enum
{
    ...
    _EC200_AT_QUERY_REV,
    _EC200_AT_SET_LTE,
    _EC200_AT_SET_URC_OFF,
    
    _EC200_AT_MINI_FUN,
    _EC200_AT_QUERY_FUN,
    _EC200_AT_SLEEP_MODE,
    
    _EC200_AT_NET_MODE,
    _EC200_AT_SET_BAND,
    _EC200_AT_QUERY_BAND,
    
    _EC200_AT_FACTORY_RS,
    _EC200_AT_DTR_MODE,
    _EC200_AT_SAVE_CONF,
    _EC200_AT_TEST_0,
    ...
    _EC200_FTP_CFG_IPV6,
    _EC200_FTP_CONTEXT,
    _EC200_FTP_ACCOUNT_1,
    _EC200_FTP_ACCOUNT_2,
    
    _EC200_FTP_FILE_BIN,
    _EC200_FTP_FILE_ASCII,
...
extern uint8_t aEC200_BLOCK_INIT[];
extern uint8_t aEC200_BLOCK_NETWORK[];

#ifdef USING_TRANSPARENT_MODE
    extern uint8_t aEC200_BLOCK_CONNECT[];
    extern uint8_t aEC200_BLOCK_PUB_FB[];
    extern uint8_t aEC200_BLOCK_PUB[];
    extern uint8_t aEC200_BLOCK_PING[];
    
    extern uint8_t aEC200_BLOCK_CSQ[];
    extern uint8_t aEC200_BLOCK_DIS_CONN[];
    extern uint8_t aEC200_BLOCK_CLOCK[];
#else
#ifdef MQTT_PROTOCOL
    extern uint8_t aEC200_BLOCK_CONNECT[];
    extern uint8_t aEC200_BLOCK_PUB_FB[];
...
extern uint8_t aEC200_BLOCK_HTTP_INIT[];
extern uint8_t aEC200_BLOCK_HTTP_READ[];

extern uint8_t aEC200_BLOCK_READ_SMS[]; 
extern uint8_t aEC200_BLOCK_SEND_SMS[];
extern uint8_t aEC200_BLOCK_CALLING[];

extern uint8_t aEC200_BLOCK_FILE_CLOSE[];

extern uint8_t aEC200_BLOCK_GNSS[]; 
extern uint8_t aEC200_BLOCK_GNSS_DELL[];
extern uint8_t aEC200_BLOCK_GNSS_ON[];

extern uint8_t aEC200_BLOCK_FTP_INIT[];
extern uint8_t aEC200_BLOCK_FTP_READ[] ;

extern uint8_t aEC200_BLOCK_FTP_1[];
extern uint8_t aEC200_BLOCK_FTP_2[];
extern uint8_t aEC200_BLOCK_FTP_CLOSE[];
