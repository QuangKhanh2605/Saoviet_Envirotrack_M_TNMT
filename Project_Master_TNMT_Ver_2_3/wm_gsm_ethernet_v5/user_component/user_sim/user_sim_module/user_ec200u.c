...
const sCommand_Sim_Struct aEC200Step[] =
{
    ...
    {   _EC200_AT_NET_MODE, 	    at_callback_success,        "OK",                   "AT+QCFG=\"nwscanmode\"\r"       },
    {   _EC200_AT_SET_BAND, 	    at_callback_success,        "OK",                   "AT+QCFG=\"band\",0,0x7FFFFFFFFFFFFFFF,1\r"       },
    {   _EC200_AT_QUERY_BAND, 	    Sim_Common_Get_Band,        "OK",                   "AT+QCFG=\"band\"\r"       },
    
    {   _EC200_AT_FACTORY_RS, 	    at_callback_success,        "OK",                   "AT&F0\r"       },
   ...
   //SMS
    ...
    {   _EC200_MQTT_PUB_PING, 	    Sim_Common_MQTT_Pub_2,      NULL,                   NULL       	        },  //Default DataPingResp_8a
    //Ping
    ...
    {   _EC200_FTP_CFG_TYPE, 	    at_callback_success,        "OK",                   "AT+QFTPCFG=\"cwdtype\",2\r"		},
    ...
    {   _EC200_FTP_FILE_SIZE_2,     _Cb_FTP_FILE_SIZE_2,        "+QFTPSIZE: ",        "\"\r"              },
...
uint32_t EC200_Get_Delay_AT (uint8_t Step)
{
    ...
    switch (Step)
    {
        ...
        case _EC200_FTP_LOGIN_1: 
            Time = 2000;
            break; 
        case _EC200_FTP_PATH_1:
            //random theo id 0->100s
            Time = MIN(sSimCommVar.TimeRandID_u32, MAX_TIME_RAND_ID) *1000;
            break;
        default:
            Time = 50;
            break;
