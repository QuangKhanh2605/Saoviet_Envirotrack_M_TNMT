...
// ********** ON - OFF POWER
#ifdef SIM_BC660_LIB
    #define SIM_PW_OFF1         HAL_GPIO_WritePin(SIM_ON_OFF_GPIO_Port, SIM_ON_OFF_Pin, GPIO_PIN_SET  )  
    #define SIM_PW_ON1          HAL_GPIO_WritePin(SIM_ON_OFF_GPIO_Port, SIM_ON_OFF_Pin, GPIO_PIN_RESET)
    ...
    // ********** ON - OFF DTR  
    #define SIM_WAKE_LOW        HAL_GPIO_WritePin(SIM_PSM_WK_GPIO_Port, SIM_PSM_WK_Pin, GPIO_PIN_RESET)
    #define SIM_WAKE_HI         HAL_GPIO_WritePin(SIM_PSM_WK_GPIO_Port, SIM_PSM_WK_Pin, GPIO_PIN_SET)
#else
    // ********** ON - OFF POWER
...
typedef struct
{
    ...
    sSmsVariable    sSms;
    sCallVariable   sCall;
    uint8_t     rTimeServer_u8;
    uint8_t     rFTPRenameFile_u8; 
}sAppSimVariable;
