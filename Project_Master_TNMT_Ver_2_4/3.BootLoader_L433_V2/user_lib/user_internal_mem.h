...
//===============Define address=================
//#define BOARD_HOA_BINH
#define BOARD_QUANG_NINH


#if defined (STM32L433xx) && defined (BOARD_HOA_BINH)
...
#if defined (STM32L433xx) && defined (BOARD_QUANG_NINH)
    #define ON_FLASH_BASE               0x08000000
    #define	ADDR_FLASH_END			    0x0803F800
    /*========Add Firmware: Main + Update=========== */
    ...
    /*=======Add Index Mess================ */
    #define	ADDR_INDEX_LOG 		        0x0803C000
