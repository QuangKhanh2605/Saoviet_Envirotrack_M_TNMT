...
//                    RS485_LogData_Calib(_RS485_SS_NH4_CALIB_K_B_NH4, &Old_Value_i16, sizeof(int16_t));
        ...
        case _LCD_SCR_CALIB_NH4_PLS:
            switch (sLCD.sScreenNow.Para_u8)
            {
                case __SET_CALIB_NH4_P1_PLS:
                    switch(sLCD.sScreenNow.SubIndex_u8)
                    {
                        case 0:
                            UTIL_MEM_cpy(&sLCD.sScreenBack, &sLCD.sScreenNow, sizeof(sScreenInformation));
                            Display_Set_Screen(&sLCD.sScreenNow, _LCD_SCR_CALIB_NH4_PLS, (sLCD.sScreenNow.SubIndex_u8+1),
                                               __SET_CALIB_NH4_P1_PLS, __SET_CALIB_NH4_P1_PLS, __SET_CALIB_NH4_RESET_PLS,
                                               &sButton.Old_value, 0xF2);
                ...
                case __SET_CALIB_NH4_P2_PLS:
                    switch(sLCD.sScreenNow.SubIndex_u8)
                    {
                        case 0:
                            UTIL_MEM_cpy(&sLCD.sScreenBack, &sLCD.sScreenNow, sizeof(sScreenInformation));
                            Display_Set_Screen(&sLCD.sScreenNow, _LCD_SCR_CALIB_NH4_PLS, (sLCD.sScreenNow.SubIndex_u8+1),
                                               __SET_CALIB_NH4_P2_PLS, __SET_CALIB_NH4_P1_PLS, __SET_CALIB_NH4_RESET_PLS,
                                               &sButton.Old_value, 0xF2);
                ...
                case __SET_CALIB_NH4_RESET_PLS:
                    UTIL_MEM_cpy(&sLCD.sScreenBack, &sLCD.sScreenNow, sizeof(sScreenInformation));
                    Display_Set_Screen(&sLCD.sScreenNow, _LCD_SCR_CHECK_SETTING, 0,
                                       __CHECK_STATE_SETTING, __CHECK_STATE_SETTING, __CHECK_STATE_SETTING,
                                       NULL, 0xF0);
...
//                    RS485_LogData_Calib(_RS485_SS_NH4_CALIB_K_B_K, &Old_Value_i16, sizeof(int16_t));
        ...
        case _LCD_SCR_CHECK_SETTING:
          switch(sLCD.sScreenBack.Index_u8)
          {
              ...
              case _LCD_SCR_CALIB_NH4:
                switch (sLCD.sScreenBack.Para_u8)
                {
                    case __SET_CALIB_NH4_RESET:
                      ...
                      Save_CalibPlus(_E_P_SLOPE, 0, 0, 0);
                      RS485_Enter_Calib();
                      break;
                    ...
                    case __SET_CALIB_NH4_P1:
                      ...
                      Save_CalibPlus(_E_P_ZERO, 1, ((float)sButton.Old_value/Calculator_Scale(sParaDisplay.Scale_NH4)),((float)sButton.Old_value/Calculator_Scale(sParaDisplay.Scale_NH4)));
                      break;
                    ...
                    case __SET_CALIB_NH4_P2:
                      ...
                      Save_CalibPlus(_E_P_SLOPE, 1, ((float)sButton.Old_value/Calculator_Scale(sParaDisplay.Scale_NH4)),((float)sButton.Old_value/Calculator_Scale(sParaDisplay.Scale_NH4)));
                      break;
            ...
            case _LCD_SCR_CALIB_NH4_PLS:
                if(sSensor_NH4.State_Measure_NH4_u8 == _MEASURE_VALID)
                {
                    On_Speaker(50);
                    sParaDisplay.State_Setting = _STATE_SETTING_DONE;
                    switch (sLCD.sScreenBack.Para_u8)
                    {
                        case __SET_CALIB_NH4_P1_PLS:
                          Save_CalibPlus(_E_P_PLS1, 1, sCalibPlus.var_x_f,((float)sButton.Old_value/Calculator_Scale(sParaDisplay.Scale_NH4)));
                          break;
                          
                        case __SET_CALIB_NH4_P2_PLS:
                          Save_CalibPlus(_E_P_PLS2, 1, sCalibPlus.var_x_f,((float)sButton.Old_value/Calculator_Scale(sParaDisplay.Scale_NH4)));
                          break;
        ...
        case _LCD_SCR_CALIB_NH4_PLS:
              if(sLCD.sScreenNow.SubIndex_u8 == 0)
              {
                    if (sLCD.sScreenNow.Para_u8 > sLCD.sScreenNow.ParaMin_u8 ) {
                        ...
                        Display_Set_Screen(&sLCD.sScreenNow, _LCD_SCR_CALIB_NH4, 0,
                                               __SET_CALIB_NH4_CONFIRM, __SET_CALIB_NH4_RESET, __SET_CALIB_NH4_CONFIRM,
                                               NULL, 0xF1);
                    }
              }
              else
...
void BUTTON_Down_Process (void)
{
    switch (sLCD.sScreenNow.Index_u8)
    {
        ...
        case _LCD_SCR_CALIB_NH4:
              ...
              {
                    if (sLCD.sScreenNow.Para_u8 == sLCD.sScreenNow.ParaMax_u8) {
                        Display_Set_Screen(&sLCD.sScreenNow, _LCD_SCR_CALIB_NH4_PLS, 0,
                                            __SET_CALIB_NH4_P1_PLS, __SET_CALIB_NH4_P1_PLS, __SET_CALIB_NH4_RESET_PLS,
                                            NULL, 0xF1);
                    } else {
                        sLCD.sScreenNow.Para_u8++;
