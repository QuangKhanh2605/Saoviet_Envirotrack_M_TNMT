...
//    sLCDObject[__SET_ALARM_STATE].pData         = &sTempAlarm.State;
    ...
    sLCDObject[__SET_CALIB_NH4_VALUE_PLS].pData       = &sParaDisplay.NH4_Raw_i32; 
    sLCDObject[__SET_CALIB_NH4_VALUE_PLS].Scale_u8    = sParaDisplay.Scale_NH4; 
    sLCDObject[__SET_CALIB_NH4_CONST_K_PLS].pData     = &sParaDisplay.NH4_K_i32; 
    sLCDObject[__SET_CALIB_NH4_CONST_K_PLS].Scale_u8  = sParaDisplay.Scale_NH4; 
    sLCDObject[__SET_CALIB_NH4_CONST_B_PLS].pData     = &sParaDisplay.NH4_B_i32; 
    sLCDObject[__SET_CALIB_NH4_CONST_B_PLS].Scale_u8  = sParaDisplay.Scale_NH4; 
    sLCDObject[__SET_CALIB_NH4_P1_PLS].pData          = &sParaDisplay.Calib_P1_Pls_i32; 
    sLCDObject[__SET_CALIB_NH4_P1_PLS].Scale_u8       = sParaDisplay.Scale_NH4; 
    sLCDObject[__SET_CALIB_NH4_P2_PLS].pData          = &sParaDisplay.Calib_P2_Pls_i32; 
    sLCDObject[__SET_CALIB_NH4_P2_PLS].Scale_u8       = sParaDisplay.Scale_NH4; 
...
void Update_ParaDisplay(void)
{
    ...
    sParaDisplay.Calib_P1_Pls_i32   = (int32_t)(sCalibPlus.PPls1.pt_y * Calculator_Scale(sParaDisplay.Scale_NH4));
    sParaDisplay.Calib_P2_Pls_i32   = (int32_t)(sCalibPlus.PPls2.pt_y * Calculator_Scale(sParaDisplay.Scale_NH4));
}
